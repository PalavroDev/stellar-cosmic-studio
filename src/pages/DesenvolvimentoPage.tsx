  ...
  const services = [
    {
      ...
      description:
        "Sites modernos, responsivos e escaláveis com as melhores tecnologias do mercado.",
    },
    {
      title: "Aplicações Mobile",
      description:
        "Apps nativos e híbridos para iOS e Android com excelente experiência de usuário.",
    },
    {
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto animate-fade-in">
            Transforme suas ideias em realidade com aplicações web e mobile de
            alta qualidade, construídas com tecnologia de ponta
          </p>
          <Link to="/contato">
      ...
      <section className="py-20 bg-background/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-center mb-4 text-foreground">
            O que podemos desenvolver para sua<span className="text-gradient"> Empresa</span>
          </h2>
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
            Soluções completas de desenvolvimento para cada necessidade
            tecnológica
          </p>
      ...
      <section className="py-20 bg-gradient-to-r from-primary via-primary/90 to-secondary relative overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Agende uma consultoria gratuita e descubra como podemos criar a
            solução perfeita
          </p>
          <Link to="/contato">
            <Button
