              ...
              >
                ...
                >
                  <Link to="/galaxia">
                    ...
                    <span className="text-sm text-muted-foreground">Plataforma de Atendimento Multi-canais</span>
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem 
                  asChild
                ...
                >
                  <Link to="/suporte">
                    ...
                    <span className="text-sm text-muted-foreground">Soluções com Equipe Especializada</span>
                  </Link>
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
